...
KEY_SetTextAndSearchEvent = "set text and search"
KEY_ExitEvent = "exit"
...
KEY_LongTouchEvent = "long touch"
KEY_SwipeEvent = "swipe"
KEY_ScrollEvent = "scroll"
KEY_SetTextEvent = "set text"
KEY_IntentEvent = "intent"
KEY_SpawnEvent = "spawn"
KEY_KillAppEvent = "kill_app"
KEY_RotateDeviceToLandscapeEvent = "rotate device right"
KEY_RotateDeviceToPortraitEvent = "rotate device neutral"
...
class TouchEvent(UIEvent):
    ...
    def __init__(self, x=None, y=None, view=None, event_dict=None):
        super().__init__()
        self.event_type = KEY_TouchEvent # click
        self.x = x
        self.y = y
        self.view = view
        if event_dict is not None:
...
class LongTouchEvent(UIEvent):
    ...
    def __init__(self, x=None, y=None, view=None, duration=2000, event_dict=None):
        super().__init__()
        self.event_type = KEY_LongTouchEvent # long click
        self.x = x
        self.y = y
        self.view = view
